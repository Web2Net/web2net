...
{
$upload_path="/image/banner/item/".$_POST['prodid']."/";
...
$uploadfile=$_POST['numer'].".png";
if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploaddir.$uploadfile)){

header("Location: /cms/banner/magic/load_prod_image.php?loadimg=".$upload_path.$uploadfile."&num=".$_POST['numer']."");    
	
//GD::imageResize($uploaddir.$uploadfile,$uploaddir.$uploadfile,740,480,100);

//header("Location: /cms/banner/magic/crop.php?img=".$upload_path.$uploadfile."&size=740x480");

//header("Location: /cms/banner/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=740x480");    
...
<table style="min-width:800px;" class="r10b">
<tr><td align="left" valign="top" style="height:100px;padding:20px;font-size:12px;">
...
</td></tr><tr><td align="center" valign="middle" style="padding:0px 25px 33px 25px;height:500px;">
<?if(!file_exists(getenv("DOCUMENT_ROOT").$_GET['img']))$_GET['img']="/design/img/noimage_450x450.png";?>
<img src="<?=$_GET['img']?>?<?=time()?>" style="border:25px solid #eee" class="r10" />
</td></tr></table>
