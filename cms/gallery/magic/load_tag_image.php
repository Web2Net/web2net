...
{
$upload_path="/image/gallery/tag/".$_POST['prodid']."/";
...
header("Location: /cms/gallery/magic/load_tag_image.php?loadimg=".$upload_path.$uploadfile."&num=".$_POST['numer']."");    
	
//GD::imageResize($uploaddir.$uploadfile,$uploaddir.$uploadfile,740,480,100);

//header("Location: /cms/param/magic/crop.php?img=".$upload_path.$uploadfile."&size=740x480");

//header("Location: /cms/param/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=740x480");    
