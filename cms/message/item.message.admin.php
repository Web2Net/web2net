...
if($event!=""){
MessageItem::Event($event,MESSAGE_ITEM_TABLE,$id);
}

$item_list=MessageItem::itemListIdData($tag);

if(INI::Life('MESSAGE_tag_list')>30){
$tag_list=MessageTag::tagListIdData();
INI::SetXXL($tag_list,'MESSAGE_tag_list');
}
$tag_list=INI::Get('MESSAGE_tag_list');
...
$tag1_list=MessageTag::tagListIdData(1);
$tpl_item->assign('tag1_list',$tag1_list);

$tag2_list=MessageTag::tagListIdData(2);
...
if($com=="edit"){
$item_data=MessageItem::itemData($id);
