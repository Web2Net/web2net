...
{
$upload_path="/image/user/item/tmp/";
...
GD::imageResize($uploaddir.$uploadfile,$uploaddir.$uploadfile,350,350,100);

//header("Location: /cms/user/magic/crop.php?img=".$upload_path.$uploadfile."&size=350x350");

header("Location: /cms/user/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=350x350");    
...
GD::imageResize(getenv("DOCUMENT_ROOT").$medimg,getenv("DOCUMENT_ROOT").$bigimg,250,250,90);
GD::imageResize(getenv("DOCUMENT_ROOT").$smallimg,getenv("DOCUMENT_ROOT").$bigimg,150,150,90);	
...
</td></tr><tr><td align="center" valign="middle" style="padding:0px 25px 27px 25px;height:450px;">
<?if(!file_exists(getenv("DOCUMENT_ROOT").$_GET['img']))$_GET['img']="/design/img/noimage_450x450.png";?>
<img src="<?=$_GET['img']?>?<?=time()?>" width="350" border="0" />
</td></tr></table>
