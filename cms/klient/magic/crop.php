...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    header("Location: /cms/user/magic/load_prod_image.php?loadimg=".str_replace(getenv("DOCUMENT_ROOT"),"",$newimg)."&num=".$pid[1]);
...
<table style="margin:7px;height:450px;"><tr><td>				
...
$s=explode("x",$_GET["size"]);
if($widthi>$heighti){$attr='height="'.$s[1].'"';}else{$attr='width="'.$s[0].'"';}	
?>
