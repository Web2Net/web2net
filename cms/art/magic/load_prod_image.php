...
{
$upload_path="/image/art/item/tmp/";
...
//header("Location: /cms/art/magic/crop.php?img=".$upload_path.$uploadfile."&size=740x740");

header("Location: /cms/art/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=740x480");    
...
<?if(!file_exists(getenv("DOCUMENT_ROOT").$_GET['img']))$_GET['img']="/design/img/noimage_740x480.png";?>
