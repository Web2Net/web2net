...
curl_setopt($curl, CURLOPT_USERAGENT, 'Opera 12.00');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    header("Location: /cms/art/magic/load_prod_image.php?loadimg=".str_replace(getenv("DOCUMENT_ROOT"),"",$newimg)."&num=".$pid[1]);
...
<?if($he=="..."){$he=500;}else{?>aspectRatio: <?=$we?>/<?=$he?>,<?}?>
  ...
  function checkCoords()
  {
    ...
    alert('Пожалуйста, выберите область изображения, а затем нажмите кнопку.');
    return false;
  };
